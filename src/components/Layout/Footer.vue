...
<template>
  <div class="">
    <!--  Footer Circles  -->
    <!--   Desktop Circle    -->
    <div class="hidden sm:flex flex-row justify-center item-center h-[450px] overflow-hidden">
      <div v-if="!redline" class="relative">
        <div
        ...
        >
          <div
            class="absolute rounded-full border top-0 left-0 right-0 bottom-0 m-auto"
            :style="{
              width: '4750px',
              height: '4750px',
